...
```{r }
jitter.subdata2 + geom_text( data = subset(subdata2.sum.of.M.Fdifference,Country.or.Area == c("Timor Leste", "Bhutan" , "Egypt")), aes(x=diff_Male ,y=diff_Female,label = Country.or.Area), col= "darkgreen")+
